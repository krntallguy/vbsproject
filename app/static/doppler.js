window.doppler = (function() {
  ...
  var getBandwidth = function(analyser, freqs) {
    ...
    //console.log( 'left BW: ' + leftBandwidth + ' right BW: ' + rightBandwidth );
  ...
  return {
    init: function(callback) {
      ...
      // above code is deprecated standard of getUserMedia;
      // https://developer.mozilla.org/en-US/docs/Web/API/MediaDevices/getUserMedia
      navigator.mediaDevices.getUserMedia( { audio: { optional: [{ echoCancellation: false }] } } )
